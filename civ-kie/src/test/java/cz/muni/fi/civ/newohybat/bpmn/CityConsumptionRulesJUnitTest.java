...
public class CityConsumptionRulesJUnitTest extends BaseJUnitTest {
    ...
    public void testCityCommunismUnitsSupport(){
		...
		Assert.assertTrue("Communism Non Military Units Consume Food",city.getUnitsFoodSupport()==2);
		Assert.assertTrue("All Food Consumption",city.getFoodConsumption()==6);
    ...
    public void testCityTheRepublicUnitsSupport(){
		...
		Assert.assertTrue("The Republic Non Military Units Consume Food",city.getUnitsFoodSupport()==2);
		Assert.assertTrue("Whole food consumption",city.getFoodConsumption()==6);
    ...
    public void testCityDemocracyUnitsSupport(){
		...
		Assert.assertTrue("Democracy Non Military Units Consume Food",city.getUnitsFoodSupport()==2);
		Assert.assertTrue("Whole food consumption",city.getFoodConsumption()==6);
