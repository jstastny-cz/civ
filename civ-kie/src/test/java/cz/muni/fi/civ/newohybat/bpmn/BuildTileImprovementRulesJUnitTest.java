...
public class BuildTileImprovementRulesJUnitTest extends BaseJUnitTest {
    /*
     * Test available action update after each move of unit. Some actions, like here irrigation, are dependent
    ...
    public void testCantIrrigateWhenCloseTilesAreNot(){
		...
		Assert.assertFalse(firedRules.contains("Build Improvement"));
		
	}
    /*
     * Tests that can Build Improvement, when close tile is irrigated
     */
    @Test
    ...
    /*
     * Tests that can Build Improvement, when close tile is ocean
     */
    @Test
    ...
    /*
     * Tests that can Build Improvement, when close tile is river
     */
    @Test
    ...
    public void testCancelIrrigation(){
		...
		// rule "Build Improvement" did fire
		Assert.assertTrue("Build Improvement Rule fired.",firedRules.contains("Build Improvement"));
		Assert.assertFalse("Process Build Improvement canceled.",tile.getImprovements().contains("irrigation"));
		Assert.assertNull("Current action should change to null", unit.getCurrentAction());
    }
